...
The notebook `scrape_100_python_jobs_in_newyork_from_indeed.ipynb` contains code where actual scrapping was executed for 100 python jobs in new york from [indeed.com](indeed.com) and the result saved to the `indeed_jobs.csv` file
