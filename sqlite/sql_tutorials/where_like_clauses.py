...
# Query table using the where and like clauses
cursor.execute("SELECT * FROM student WHERE email LIKE '%yahoo%' ") # values that have the word `yahoo` anywhere in the email column
